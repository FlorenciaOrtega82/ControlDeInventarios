            ...
            <div className="contentCard">
                <div className="card">
                    ...
                    <span className="ayuda">
                        {" "}
                        Puedes crear una cuenta nueva ó <br></br>solicitar a tu
                        empleador una. <MdOutlineInfo />
                    </span>
...
const Container = styled.div`
    ...
    .contentCard {
        ...
        &:hover {
            ...
            .cuadros {
                transform: rotate(37deg) rotateX(5deg) rotateY(12deg)
                    rotate(3deg) skew(2deg) skewY(1deg) scaleX(1.2) scaleY(1.2);
                color: red;
            }
        }
    }
